...
@section('content')
    ...
    <section class="container py-5 mt-5 mb-lg-3">
        <div class="row align-items-center mt-md-2">
            <div class="col-lg-7 order-lg-2 mb-lg-0 mb-4 pb-2 pb-lg-0"><img class="d-block mx-auto"
                    src="{{asset('theme-assets/img/city-guide/home/hero-img.jpg')}}" width="746" alt="Hero image"></div>
            <div class="col-lg-5 order-lg-1 pe-lg-0">
                <h1 class="display-5 mb-4 ms-lg-n5 text-lg-start text-right mb-4">رزرو تور مسافرتی <span
                        class="dropdown d-inline-block"><a class="dropdown-toggle text-decoration-none" href="#"
                            role="button" data-bs-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">کیش</a><span class="dropdown-menu dropdown-menu-end my-1"><a
                                class="dropdown-item fs-base fw-bold" href="#">مشهد</a><a
                                class="dropdown-item fs-base fw-bold" href="#">مازندران</a><a
                                class="dropdown-item fs-base fw-bold" href="#">تبریز</a><a
                                class="dropdown-item fs-base fw-bold" href="#">اردبیل</a></span></span></h1>
                <p class="text-lg-start text-right mb-4 mb-lg-5 fs-lg">
                    جستجو در بین بهترین آژانس های کشور
                </p>
                <!-- Search form-->
                <div class="ms-lg-n5">
                    <form class="form-group d-block d-md-flex position-relative rounded-md-pill me-lg-n5">
                        <div class="input-group input-group-lg border-end-md"><span
                                class="input-group-text text-muted rounded-pill pe-3"><i class="fi-search"></i></span>
                            ...
                            <div class="dropdown w-100 mb-sm-0 mb-3" data-bs-toggle="select">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="#"><i
                                                ...
                                                class="dropdown-item-label">هتل</span></a></li>
                                    <li><a class="dropdown-item" href="#"><i
                                                class="fi-entertainment fs-lg opacity-60 me-2"></i><span
                                                class="dropdown-item-label">ویلا و اقامتگاه</span></a></li>
                                </ul>
                            </div>
                            <button class="btn btn-primary btn-lg rounded-pill w-100 w-md-auto me-sm-3"
    ...
    <!-- Categories-->
    <section class="container d-flex flex-wrap flex-column flex-sm-row pb-5 mb-md-3 categories-guid"><a
            class="icon-box card flex-row align-items-center flex-shrink-0 card-hover border-0 shadow-sm rounded-pill py-2 pe-2 ps-4 mb-2 mb-sm-3 ms-sm-3 ms-xxl-4"
            href="">
            <div class="icon-box-media bg-faded-accent text-accent rounded-circle me-2"><i class="fi-bed"></i>
            </div>
            <h3 class="icon-box-title fs-base ps-1 pe-2 mb-0">اقامتگاه و بوم گردی</h3>
        </a><a
            class="icon-box card flex-row align-items-center flex-shrink-0 card-hover border-0 shadow-sm rounded-pill py-2 pe-2 ps-4 mb-2 mb-sm-3 ms-sm-3 ms-xxl-4"
            href="">
            <div class="icon-box-media bg-faded-warning text-warning rounded-circle me-2"><i class="fi-cafe"></i>
            </div>
            <h3 class="icon-box-title fs-base ps-1 pe-2 mb-0">رستوران و کافی شاپ</h3>
        </a><a
            class="icon-box card flex-row align-items-center flex-shrink-0 card-hover border-0 shadow-sm rounded-pill py-2 pe-2 ps-4 mb-2 mb-sm-3 ms-sm-3 ms-xxl-4"
            href="">
            <div class="icon-box-media bg-faded-primary text-primary rounded-circle me-2"><i class="fi-shopping-bag"></i>
            </div>
            <h3 class="icon-box-title fs-base ps-1 pe-2 mb-0">مراکز خرید</h3>
        </a><a
            class="icon-box card flex-row align-items-center flex-shrink-0 card-hover border-0 shadow-sm rounded-pill py-2 pe-2 ps-4 mb-2 mb-sm-3 ms-sm-3 ms-xxl-4"
            href="">
            <div class="icon-box-media bg-faded-success text-success rounded-circle me-2"><i class="fi-museum"></i></div>
            <h3 class="icon-box-title fs-base ps-1 pe-2 mb-0">هنر و تئاتر</h3>
        </a><a
            class="icon-box card flex-row align-items-center flex-shrink-0 card-hover border-0 shadow-sm rounded-pill py-2 pe-2 ps-4 mb-2 mb-sm-3 ms-sm-3 ms-xxl-4"
            href="">
            <div class="icon-box-media bg-faded-primary text-primary rounded-circle me-2"><i class="fi-entertainment"></i>
            </div>
            <h3 class="icon-box-title fs-base ps-1 pe-2 mb-0">تفریحی و ورزشی</h3>
        </a>
        <div class="dropdown mb-2 mb-sm-3"><a
                class="icon-box card flex-row align-items-center flex-shrink-0 card-hover border-0 shadow-sm rounded-pill py-2 pe-2 ps-4"
                href="#" data-bs-toggle="dropdown">
                <div class="icon-box-media bg-faded-info text-info rounded-circle me-2"><i class="fi-dots-horisontal"></i>
                </div>
                <h3 class="icon-box-title fs-base ps-1 pe-2 mb-0">سایر</h3>
            </a>
            <div class="dropdown-menu dropdown-menu-sm-end my-1"><a class="dropdown-item fw-bold"
                    href=""><i class="fi-meds fs-base opacity-60 me-2"></i>سلامتی و
                    پزشکی</a><a class="dropdown-item fw-bold" href=""><i
                        class="fi-makeup fs-base opacity-60 me-2"></i>آرایشی و زیبایی</a><a class="dropdown-item fw-bold"
                    href=""><i class="fi-car fs-base opacity-60 me-2"></i>خدمات خودرو</a><a
                    class="dropdown-item fw-bold" href=""><i
                        class="fi-dumbell fs-base opacity-60 me-2"></i>ورزشی</a><a class="dropdown-item fw-bold"
                    href=""><i class="fi-disco-ball fs-base opacity-60 me-2"></i>تور و سفر</a>
            </div>
        </div>
    </section>
    <!-- Where to stay-->
                    ...
                    <div class="position-relative">
                        <div class="position-relative mb-3">
                            <button
                                ...
                                type="button" data-bs-toggle="tooltip" data-bs-placement="right" title="نشان کردن"><i
                                    class="fi-heart"></i></button><img class="rounded-3"
                                src="{{asset('theme-assets/img/city-guide/catalog/01.jpg')}}" alt="Image">
                        </div>
                        <h3 class="mb-2 fs-lg"><a class="nav-link stretched-link" href="{{ url('/detail') }}">هتل اسپیناس</a></h3>
                        <ul class="list-inline mb-0 fs-sm">
                            <li class="list-inline-item ps-1"><i
                                    class="fi-star-filled mt-n1 ms-1 fs-base text-warning align-middle"></i><b>5.0</b><span
                                    class="text-muted">&nbsp;(48)</span></li>
                            <li class="list-inline-item ps-1"><i
                                    class="fi-credit-card mt-n1 ms-1 fs-base text-muted align-middle"></i>150000
                                تومان</li>
                    ...
                    <div class="position-relative">
                        <div class="position-relative mb-3">
                            <button
                                ...
                                type="button" data-bs-toggle="tooltip" data-bs-placement="right" title="نشان کردن"><i
                                    class="fi-heart"></i></button><img class="rounded-3"
                                src="{{asset('theme-assets/img/city-guide/catalog/02.jpg')}}" alt="Image">
                        </div>
                        <h3 class="mb-2 fs-lg"><a class="nav-link stretched-link" href="{{ url('/detail') }}">هتل الماس</a></h3>
                        <ul class="list-inline mb-0 fs-sm">
                            <li class="list-inline-item ps-1"><i
                                    class="fi-star-filled mt-n1 ms-1 fs-base text-warning align-middle"></i><b>4.8</b><span
                                    class="text-muted">&nbsp;(24)</span></li>
                            <li class="list-inline-item ps-1"><i
                                    class="fi-credit-card mt-n1 ms-1 fs-base text-muted align-middle"></i>1850000
                                تومان</li>
                    ...
                    <div class="position-relative">
                        <div class="position-relative mb-3">
                            <button
                                ...
                                type="button" data-bs-toggle="tooltip" data-bs-placement="right" title="نشان کردن"><i
                                    class="fi-heart"></i></button><img class="rounded-3"
                                src="{{asset('theme-assets/img/city-guide/catalog/03.jpg')}}" alt="Image">
                        </div>
                        <h3 class="mb-2 fs-lg"><a class="nav-link stretched-link" href="{{ url('/detail') }}">باغ ویلای
                                شب بهشت</a></h3>
                        <ul class="list-inline mb-0 fs-sm">
                            <li class="list-inline-item ps-1"><i
                                    class="fi-star-filled mt-n1 ms-1 fs-base text-warning align-middle"></i><b>4.9</b><span
                                    class="text-muted">&nbsp;(43)</span></li>
                            <li class="list-inline-item ps-1"><i
                                    class="fi-credit-card mt-n1 ms-1 fs-base text-muted align-middle"></i>750000
                                تومان</li>
                        </ul>
                    </div>
                </div>
    ...
    {{-- <section class="container mb-5 pb-lg-3">
        <div class="d-md-flex align-items-center justify-content-between mb-4 pb-md-2">
            <h2 class="h4 w-100 mb-md-0 font-vazir">رویدادهای آینده در برلین</h2>
            <!-- Sorting by date-->
            <div class="w-100 me-md-3 mb-n3 pt-2 pb-3 px-1" data-simplebar data-simplebar-auto-hide="false">
                <div class="d-flex align-items-center">
                    <div class="input-group input-group-sm flex-shrink-0 me-md-auto me-3" style="max-width: 180px;">
                        <input class="form-control rounded-pill pe-5" id="date-event" type="text"
                            placeholder="انتخاب تاریخ"
                            data-datepicker-options="{&quot;altInput&quot;: true, &quot;altFormat&quot;: &quot;F j, Y&quot;, &quot;dateFormat&quot;: &quot;Y-m-d&quot;}"><i
                            class="fi-calendar position-absolute top-50 start-0 translate-middle-y ms-3 ps-1"></i>
                    </div><a class="btn btn-sm btn-secondary rounded-pill fw-normal ms-n1 me-3" href="#">فردا</a><a
                        class="btn btn-sm btn-secondary rounded-pill fw-normal ms-n1 ms-3" href="#">هفته
                        جاری</a><a class="btn btn-link me-md-3 me-auto p-0 fw-normal"
                        href="">مشاهده همه<i class="fi-arrow-long-left ms-2"></i></a>
                </div>
            </div>
        </div>
            ...
            <div class="tns-carousel-inner"
                ...
                <div>
                    <div class="card border-0 bg-size-cover pt-5"
                        style="background-image: url({{asset('theme-assets/img/city-guide/home/upcoming-1.jpg')}});">
                            ...
                            <div class="d-md-flex justify-content-between align-items-end">
                                <div class="me-2 mb-4 mb-md-0">
                                    <div
                                        ...
                                        <div class="text-nowrap me-3"><i class="fi-calendar-alt ms-1 opacity-70"></i><span
                                                class="align-middle">15 خرداد</span></div>
                                        <div class="text-nowrap"><i class="fi-clock ms-1 opacity-70"></i><span
                                                class="align-middle">21:00</span></div>
                                    </div>
                                    <h3 class="h5 text-light mb-0">بازیگری در موسسه تراشه تصویر</h3>
                                </div>
                                <div class="btn-group">
                                    <button
                                        class="btn btn-primary border-start-0 border-top-0 border-bottom-0 border-light rounded-pill rounded-start-0 px-3"
                                        type="button"><i class="fi-heart"></i></button>
                                    <a class="btn btn-primary rounded-pill rounded-end-0 px-3" href="#">قیمت
                                        بلیط از 5000 تومان</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    <div class="card border-0 bg-size-cover pt-5"
                        style="background-image: url({{asset('theme-assets/img/city-guide/home/upcoming-2.jpg')}});">
                        <div class="d-none d-md-block" style="height: 13rem;"></div>
                        <div class="card-body text-center text-md-start pt-4 pt-xl-0">
                            <div class="d-md-flex justify-content-between align-items-end">
                                <div class="me-2 mb-4 mb-md-0">
                                    <div
                                        class="d-flex justify-content-center justify-content-md-start text-light fs-sm mb-2">
                                        <div class="text-nowrap me-3"><i class="fi-calendar-alt ms-1 opacity-70"></i><span
                                                class="align-middle">2 مرداد</span></div>
                                        <div class="text-nowrap"><i class="fi-clock ms-1 opacity-70"></i><span
                                                class="align-middle">10:00</span></div>
                                    </div>
                                    <h3 class="h5 text-light mb-0">عکاسی صنعتی در آتلیه کات</h3>
                                </div>
                                <div class="btn-group">
                                    <button
                                        class="btn btn-primary border-start-0 border-top-0 border-bottom-0 border-light rounded-pill rounded-start-0 px-3"
                ...
                <div>
                    <div class="card border-0 bg-size-cover pt-5"
                        style="background-image: url({{asset('theme-assets/img/city-guide/home/upcoming-3.jpg')}});">
                        <div class="d-none d-md-block" style="height: 13rem;"></div>
                        <div class="card-body text-center text-md-start pt-4 pt-xl-0">
                            <div class="d-md-flex justify-content-between align-items-end">
                                <div class="me-2 mb-4 mb-md-0">
                                    <div
                                        class="d-flex justify-content-center justify-content-md-start text-light fs-sm mb-2">
                                        <div class="text-nowrap me-3"><i class="fi-calendar-alt ms-1 opacity-70"></i><span
                                                class="align-middle">11 شهریور</span></div>
                                        <div class="text-nowrap"><i class="fi-clock ms-1 opacity-70"></i><span
                                                class="align-middle">18:00</span></div>
                                    </div>
                                    <h3 class="h5 text-light mb-0">استدیو فیلم و عکس جاست</h3>
                                </div>
                                <div class="btn-group">
                                    <button
                                        class="btn btn-primary border-start-0 border-top-0 border-bottom-0 border-light rounded-pill rounded-start-0 px-3"
    ...
    <section class="container mt-n3 mt-md-0 mb-5 pb-lg-4">
        <h2 class="h4 font-vazir mb-4 pb-2">اخبار جدید</h2>
        <!-- Carousel-->
                ...
                <div>
                    <div class="row">
                        <div class="col-md-7 mb-md-0 mb-3"><img class="position-relative rounded-3 zindex-5"
                                src="{{asset('theme-assets/img/city-guide/home/new-1.jpg')}}" alt="Article image"></div>
                        <div class="col-md-5">
                            <h3 class="h4 from-top">افتتاح شهر بازی جدید</h3>
                            <ul class="list-unstyled delay-2 from-end">
                                <li class="mb-1 fs-sm"><i class="fi-map-pin text-muted me-2 fs-base"></i>بزرگراه
                                    چمران ، خیابان اصلی </li>
                                <li class="mb-1 fs-sm"><i class="fi-clock text-muted me-2 fs-base"></i>9:00 –
                                    23:00</li>
                                <li class="mb-1 fs-sm"><i class="fi-wallet text-muted me-2 fs-base"></i>50000
                                    تومان</li>
                            </ul>
                            {{-- <p class="pb-2 delay-3 from-end d-none d-lg-block line-h18">لورم ایپسوم متن ساختگی با
                                ...
                                <a
                                class="btn btn-primary rounded-pill delay-4 scale-up" href="">ادامه
                                مطلب<i class="fi-chevron-right fs-sm ms-2"></i></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-faded-accent rounded-3">
            <div class="row align-items-center">
                <div class="col-lg-5 col-md-6 ps-lg-5">
                    <div class="pe-xl-5 pe-md-0 pt-4 pb-md-4 px-3 text-right text-md-start">
                        <h2 class="mb-md-3 pt-2 pt-md-0 mb-2 pb-md-0 pb-1">دانلود اپلیکیشن</h2>
                        <p class="mb-4 pb-xl-3 fs-md">اپلیکیشن را دانلود کنید سپس به دور دنیا سفر کنید!</p>
                        <div class="d-flex flex-column flex-sm-row justify-content-center justify-content-md-start">
                            <a class="btn-market ms-sm-3 mb-3" href="#" role="button">
                                ...
                                </svg></a><a class="btn-market mb-3" href="#" role="button"><svg
                                    xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'
                                    width='140' height='34' fill='none'>
                                    <g fill='#fff'>
                                        <path
                ...
                <div class="col-lg-7 col-md-6"><img class="d-none d-md-block" src="{{asset('theme-assets/img/city-guide/illustrations/app.png')}}"
                        width="698" alt="Illustration"><img class="d-block d-md-none mx-auto"
                        src="{{asset('theme-assets/img/city-guide/illustrations/app-m.png')}}" width="446" alt="Illustration"></div>
            </div>
        </div>
    </section>
